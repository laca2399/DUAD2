...
#    write_data(CARTS_FILE, read_data(CARTS_FILE))  # Guardar el carrito actualizado
...
#            return jsonify({"message": "Not enough stock for product ID " + str(item["product_id"])}), 400
#    
